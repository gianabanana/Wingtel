...
<head>
  ...
  <body>
		...
		?>
<br /><br />
		<h1><p align="center"><strong>LIST OF ALL DEPENDENT RECORDS</strong></p></h1>
		...
		<?php
			...
			if (!$DBConnect) {
				...
				$SQLQuery = "select * from dependent ";
		...
		<?php
					...
					echo '<font size="+2" color="red">SORRY, there are no Dependent records to display.</font>';
				}
			}
