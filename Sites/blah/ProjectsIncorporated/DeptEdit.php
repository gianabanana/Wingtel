...
<body>
	<div id="container">
		...
		<form action="DeptEditTest.php" method="POST">
			<table align="center">		
		<?php
		...
		?>
				<tr>
					<td>Choose the Department No.: </td>
					<td><select name="deptno" id="deptno">
		<?php
				while ($deptobject = mysqli_fetch_object($QueryResult)) {
					echo '<option value="'.$deptobject->DeptNo.'">'.$deptobject->DeptNo.' - '.$deptobject->DeptName.'</option>';
				}
		?>
						</select>
					</td>
