        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $username, $hashed_password, $fname, $mname, $lname, $count, $addr, $bday, $contactnum, $citizen, $validid);
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION['country'] = $count;
                            $_SESSION['address'] = $addr;
                            $_SESSION['bday'] = $bday;
                            $_SESSION['citizenship'] = $citizen;
