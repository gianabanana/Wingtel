...
"color: rgb(255, 255, 255);"));
    ...
    {
        enrollment->setWindowTitle(QApplication::translate("enrollment", "Form", 0));
        pushButtonCancel->setText(QApplication::translate("enrollment", "CANCEL", 0));
        pushButtonSearch->setText(QApplication::translate("enrollment", "Search", 0));
        enrollstudent->setText(QApplication::translate("enrollment", "ENROLL STUDENT", 0));
        pushButtonSearch_2->setText(QApplication::translate("enrollment", "Search", 0));
        cancel_2->setText(QApplication::translate("enrollment", "CANCEL", 0));
        addsubjtodata->setText(QApplication::translate("enrollment", "ADD SUBJECT", 0));
        label->setText(QApplication::translate("enrollment", "Sections available:", 0));
        pushButtonAddSection->setText(QApplication::translate("enrollment", "ENROLL", 0));
        pushButtonCancelSection->setText(QApplication::translate("enrollment", "CANCEL", 0));
        label_2->setText(QString());
        label_4->setText(QString());
        labelName_3->setText(QApplication::translate("enrollment", "Name:", 0));
        labelIDno_3->setText(QApplication::translate("enrollment", "ID No.:", 0));
        username->setText(QString());
        name->setText(QString());
        labelYearLevel_3->setText(QApplication::translate("enrollment", "Year Level:", 0));
        yearlevel->setText(QString());
        labelDepartment_3->setText(QApplication::translate("enrollment", "Department:", 0));
        department->setText(QString());
        unenrollSub->setText(QApplication::translate("enrollment", "UNENROLL SUBJECT", 0));
        label_3->setText(QApplication::translate("enrollment", "Schedule", 0));
        enrollsubj->setText(QApplication::translate("enrollment", "ENROLL SUBJECT", 0));
        addsubj->setText(QApplication::translate("enrollment", "ADD SUBJECT", 0));
        cancel->setText(QApplication::translate("enrollment", "CANCEL", 0));
        removeSub->setText(QApplication::translate("enrollment", "REMOVE SUBJECT", 0));
        date_2->setText(QApplication::translate("enrollment", "D", 0));
        time_2->setText(QApplication::translate("enrollment", "D", 0));
    } // retranslateUi
