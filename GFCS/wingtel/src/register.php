          ...
          <form action="" method="post">
            ...
            <div class="row text-center" style="margin-left: 50px;">
              ...
              <div class="phoneNumber">
                Mobile Number: <input id="phoneNumber" name="phoneNumber" placeholder="Enter mobile number" type="text">
              </div>
            </div>
            <div class="row text-center" style="margin-left: 50px;">
              <div class="password">
              ...
              <div class="passport">
                Passport: <input id="passport" name="passport" placeholder="Enter passport" type="text">
              </div>
            </div>
            <input type="submit" name="submit" value="Register" class="btn-register">
  					<p>Already a member? <a href="src/login.php">Log in</a></p><br>
