...
const QMetaObject records::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_records.data,
      qt_meta_data_records,  qt_static_metacall, nullptr, nullptr}
};
...
void *records::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_records.stringdata0))
        return static_cast<void*>(const_cast< records*>(this));
